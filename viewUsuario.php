                ...
                if (!empty($row['cnpj'])) { ?>
                  <div class="row">
                    <div class="form-group col-md-5">
                      ...
                      <input type="text" name="cnpj" class="form-control" id="inputNome" placeholder="Digite o nome" value="<?php echo $row['cnpj'] ?>" disabled>
                    </div>
                  </div>
                <?php } 
                 if (!empty($row['nid'])) { ?>
                  <div class="row">
                    <div class="form-group col-md-5">
                      <label for="inputNome">Número de indentificação</label>
                      <input type="text" name="cnpj" class="form-control" id="inputNome" placeholder="Digite o nome" value="<?php echo $row['nid'] ?>" disabled>
                    </div>
                    <div class="form-group col-md-4">
                      <label for="inputNome">Salário</label>
                      <input type="text" name="cnpj" class="form-control" id="inputNome" placeholder="Digite o nome" value="<?php echo $row['salario'] ?>" disabled>
                    </div>
                    <div class="form-group col-md-3">
                      <label for="inputNome">Cargo</label>
                      <input type="text" name="cnpj" class="form-control" id="inputNome" placeholder="Digite o nome" value="<?php echo $row['cargo'] ?>" disabled>
                    </div>
                  </div>
                <?php } ?> 
